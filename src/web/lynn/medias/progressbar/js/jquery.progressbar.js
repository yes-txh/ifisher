	...
	$.extend({
		progressBar: new function() {
			this.defaults = {
				...
				stepDuration	: 500,			// setInterval的时间参数，单位ms
				max		: 100,			// 最大值
				...
				boxImage	: '/media/progressbar/images/progressbar.gif',// boxImage : 包着进度条的图片
				barImage	: {
								0:  '/media/progressbar/images/progressbg_red.gif',
								30: '/media/progressbar/images/progressbg_orange.gif',
								50: '/media/progressbar/images/progressbg_black.gif',
								70: '/media/progressbar/images/progressbg_green.gif',
								90: '/media/progressbar/images/progressbg_yellow.gif',
