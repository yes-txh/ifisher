$(function(){
	var pre_states = []
	var report = []
	function init_Job_install_state(){
		$.getJSON('/ajax/job_install_state',function(data){
	...
	init_Job_install_state();
	setInterval(getJob_install_state,10005 );
});
